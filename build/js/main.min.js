...
/* harmony import */ var _modules_form_validation_init_form_validate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/form-validation/init-form-validate */ "./js/modules/form-validation/init-form-validate.js");
...
/* harmony import */ var _modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/smooth-scroll */ "./js/modules/smooth-scroll.js");
/* harmony import */ var _modules_set_page_padding__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/set-page-padding */ "./js/modules/set-page-padding.js");
/* harmony import */ var _modules_init_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-js */ "./js/modules/init-js.js");
/* harmony import */ var _modules_local_storage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/local-storage */ "./js/modules/local-storage.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_init_js__WEBPACK_IMPORTED_MODULE_6__["initJs"])();
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_form_validation_init_form_validate__WEBPACK_IMPORTED_MODULE_2__["initFormValidate"])();
    Object(_modules_local_storage__WEBPACK_IMPORTED_MODULE_7__["initForm"])();
    Object(_modules_accordions_init_accordion__WEBPACK_IMPORTED_MODULE_3__["initAccordions"])();
    Object(_modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_4__["initAnchors"])();
    window.addEventListener('resize', _modules_set_page_padding__WEBPACK_IMPORTED_MODULE_5__["resizeWindow"]);
  });
}); // ---------------------------------
...
/***/ "./js/modules/form-validation/form-validate.js":
/*!*****************************************************!*\
  !*** ./js/modules/form-validation/form-validate.js ***!
  \*****************************************************/
...
/***/ "./js/modules/form-validation/init-form-validate.js":
/*!**********************************************************!*\
  !*** ./js/modules/form-validation/init-form-validate.js ***!
  \**********************************************************/
...
/* harmony import */ var _form_validate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form-validate */ "./js/modules/form-validation/form-validate.js");
...
var initJs = function initJs() {
  var disabledElements = document.querySelectorAll('.no-js');
...
/*!*************************************!*\
  !*** ./js/modules/local-storage.js ***!
  \*************************************/
/*! exports provided: fillForm, initForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var onFormSubmit = function onFormSubmit(evt) {
  ...
  localStorage.setItem("form[".concat(formName, "]"), json);
};

var fillForm = function fillForm(form) {
  var formName = form.id;

  if (!localStorage.length) {
    return;
  } else {
    var json = localStorage.getItem("form[".concat(formName, "]"));
...
/* harmony import */ var _local_storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../local-storage */ "./js/modules/local-storage.js");
/* harmony import */ var _modals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modals */ "./js/modules/modals/modals.js");
...
var settings = {
  ...
  'callback': {
    openCallback: function openCallback() {
      Object(_local_storage__WEBPACK_IMPORTED_MODULE_0__["fillForm"])(document.querySelector('#callback-form'));
    }
  }
};
...
var initModals = function initModals() {
  ...
  modals = new _modals__WEBPACK_IMPORTED_MODULE_1__["Modals"](settings); // Используйте в разработке экспортируемую переменную modals, window сделан для бэкэнда
...
/***/ "./js/modules/set-page-padding.js":
/*!****************************************!*\
  !*** ./js/modules/set-page-padding.js ***!
  \****************************************/
...
var paddingWrapper = document.querySelector('.intro-content');
var header = document.querySelector('.header');

var setPageWrapperPadding = function setPageWrapperPadding() {
  ...
  var breakpointChecker = function breakpointChecker() {
    if (breakpoint.matches) {
      paddingWrapper.style.paddingTop = "".concat(header.getBoundingClientRect().height, "px");
    } else {
